const info = {
    "info": `Name: 4L1C3 ( Alice )<br>
Voicer: Kanomwan<br>
Pronouns: She/her<br>
Age: Look like 12<br>
Birthday: ?<br>
Likes: Friend , Kindness<br>
Dislikes: Dog`,
    "desc":"A cyborg alien soldier sent to Earth to scout its environment. <br>She's robotic and quiet, doesn't talk much, but is very smart."
}
...
<b>1.00</b><br>
​Japanese<br>
Monopitch - Have vocal fry (vowel only)<br>
Strong ?<br>
​C4`,
...
const Gallery = ["Concept Art.png","DPE1-YcU8AEcR4y.jpg","4L1C3 Human version (Reference).png"]
...
txt=txt+ `<div class="w3-quarter w3-padding w3-animate-opacity"><a href="../Img/4L1C3/${Gallery[i]}" target="_blank"><img src="../Img/4L1C3/${Gallery[i]}" class="w3-hover-opacity" alt="img" height="200px" width="300px" style="object-position: 0px -20px;object-fit: cover;"></a></div>`
     }
